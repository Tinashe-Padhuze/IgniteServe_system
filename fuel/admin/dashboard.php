            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                       ...
                       <!-- <li> <a class="nav-label" href="#"></a>Home</li>-->
                        ...
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from fuelstation";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
													
													echo $rws;?></h2>
                                    <p class="m-b-0">Fuel Stations</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from flstat_category";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
													
													echo $rws;?></h2>
                                    <p class="m-b-0">FuelStation Categories</p>
                                </div>
                            </div>
                        </div>
                    </div> 
